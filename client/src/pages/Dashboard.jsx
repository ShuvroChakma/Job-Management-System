  ...
  return (
    <div className='min-h-screen'>
        ...
        <div className='px-5 flex justify-between items-center'>
            ...
            {companyData && (
                 ...
                 <div className='relative group'>
                     ...
                     <div className='absolute hidden group-hover:block top-1 right-0 z-10 text-white rounded pt-12'>
                         <ul className='list-none m-0 p-2 bg-blue-500 rounded-md border text-sm'>
                             <li onClick={logout} className='py-1 px-2 cursor-pointer pr-10 hover:'>Logout</li>
                         </ul>
                     </div>
                 </div>
             </div>
      ...
      <div className='flex items-start'>
        {/* Left side bar with option to crud jobs*/}
